...
/**
 * Statement generated by `collection.remove()`.
 */
interface CollectionRemove extends Binding<CollectionRemove>, Limiting<CollectionRemove>, Ordering<CollectionRemove> {
    /**
