...
describe('Datatypes Protobuf Adapter', () => {
    ...
    context('extractAny()', () => {
        ...
        it('extracts a JavaScript primitive type from a Mysqlx.Datatypes.Any', () => {
            ...
            // eslint-disable-next-line node/no-deprecated-api
            foo.setValue(tools.createTypedArrayFromBuffer(new Buffer(expected)));
        ...
        it('extracts a JavaScript Array from a Mysqlx.Datatypes.Any', () => {
            ...
            const foo = new Scalar.String();
            // eslint-disable-next-line node/no-deprecated-api
            foo.setValue(tools.createTypedArrayFromBuffer(new Buffer(expected[0])));
        ...
        it('extracts a JavaScript Object from a Mysqlx.Datatypes.Any', () => {
            ...
            // eslint-disable-next-line node/no-deprecated-api
            bar.setValue(tools.createTypedArrayFromBuffer(new Buffer('bar')));
    ...
    context('extractScalar()', () => {
        it('returns a Node.js buffer for binary data', () => {
            ...
            octets.setValue(tools.createTypedArrayFromBuffer(data));
        ...
        it('returns a JavaScript string for textual data', () => {
            ...
            // eslint-disable-next-line node/no-deprecated-api
            octets.setValue(tools.createTypedArrayFromBuffer(new Buffer('foo')));
