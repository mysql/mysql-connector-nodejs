...
describe('Prepare Protobuf Adapter', () => {
    let Prepare;
    ...
    context('encodeDeallocate()', () => {
        ...
        it('encodes a Mysqlx.Prepare.Deallocate message', () => {
            ...
            td.when(FakeDeallocateStub.prototype.serializeBinary()).thenReturn(bytes);
    ...
    context('encodeExecute()', () => {
        ...
        it('encodes a Mysqlx.Prepare.Execute message with a CRUD query', () => {
            ...
            td.when(FakeExecuteStub.prototype.serializeBinary()).thenReturn(bytes);
    ...
    context('encodePrepare()', () => {
        ...
        it('encodes a Mysqlx.Prepare.Prepare message with a CRUD query', () => {
            ...
            td.when(FakePrepareStub.prototype.serializeBinary()).thenReturn(bytes);
