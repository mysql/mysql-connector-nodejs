...
describe('Schema', () => {
    ...
    context('dropTable()', () => {
        it('should return true if the table was dropped', () => {
            ...
            td.when(execute()).thenResolve();
            td.when(stmtExecute('foo', 'DROP TABLE `bar`.`baz`')).thenReturn({ execute });

            return expect(instance.dropTable('baz')).to.eventually.be.true;
        });
        ...
        it('should fail if an unexpected error was thrown', () => {
            ...
            return expect(instance.dropTable('baz')).to.eventually.be.rejectedWith(error);
        });
    });
    ...
    context('dropView()', () => {
        it('should return true if the view was dropped', () => {
            ...
            td.when(execute()).thenResolve();
            td.when(stmtExecute('foo', 'DROP VIEW `bar`.`baz`')).thenReturn({ execute });

            return expect(instance.dropView('baz')).to.eventually.be.true;
        });
        ...
        it('should fail if an unexpected error was thrown', () => {
            ...
            return expect(instance.dropView('baz')).to.eventually.be.rejectedWith(error);
        });
    });
