...
CollectionModify.prototype.unset = function (fields) {
    ...
    fields.forEach(function (field) {
        self._operations.push(getOperation(Client.updateOperations.ITEM_REMOVE, field));
    });
    return this;
};
...
CollectionModify.prototype.execute = function () {
    return this
        ._session
        ._client
        .crudModify(this._session, this._schema.getName(), this._collection, Client.dataModel.DOCUMENT, this._query, this._operations);
};
