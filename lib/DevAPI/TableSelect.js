...
/**
 * Uses SHARED locking mode.
 * @returns {TableSelect}
 */
TableSelect.prototype.lockShared = function () {
    this._lockingMode = LOCK.SHARED;
 ...
 * @returns {TableSelect}
 */
TableSelect.prototype.lockExclusive = function () {
    this._lockingMode = LOCK.EXCLUSIVE;
...
TableSelect.prototype.execute = function (rowcb, metacb) {
    return this
        ._session
        ._client
        .crudFind(this._session, this._schema.getName(), this._table, Client.dataModel.TABLE, parseExpressionInputs(this._projection), this._where, this._groupby, this._having, this._orderby, this._limit, rowcb, Column.metaCB(metacb), this._bounds, this._joins, this._lockingMode)
