...
function TableSelect (session, schema, tableName, projections) {
    const state = { category, criteria: 'true', preparable: preparing({ session }), schema, session, tableName };
    ...
    return Object.assign({}, base, {
        ...
        execute (dataCursor, metadataCursor) {
            const fn = () => this.getSession()._client.crudFind(this, dataCursor, columnWrapper(metadataCursor));
