...
CollectionFind.prototype.execute = function (rowcb) {
    ...
    return this
        ._session
        ._client
        .crudFind(this._session, this._schema.getName(), this._collection, Client.dataModel.DOCUMENT, this._projection, this._query, null, null, this._limit, cb).then(state => new Result(state));
};
