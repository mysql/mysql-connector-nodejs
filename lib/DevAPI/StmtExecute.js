...
function StmtExecute (session, raw, args, namespace) {
    return Object.assign({}, statement({ args: args || [], raw, namespace: namespace || statement.Type.CLASSIC, session }), {
         ...
         * @function
         * @name module:StmtExecute#execute
         * @param {module:StmtExecute~rowCursor} rowcb - Callback function to handle results, or an object with both callback functions.
         * @param {module:StmtExecute~metadataCursor} [metacb] - Callback function to handle metadata.
         * @example
