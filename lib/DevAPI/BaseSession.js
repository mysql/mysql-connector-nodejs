...
BaseSession.prototype.createSchema = function (schema) {
    var self = this;
    return this._protocol.sqlStmtExecute("CREATE DATABASE " +  Table.escapeIdentifier(schema)).then(function () {
...
BaseSession.prototype.dropSchema = function (schema) {
    var self = this;
    return  self._protocol.sqlStmtExecute("DROP DATABASE " + Table.escapeIdentifier(schema)).then(function () {
        return true;
    });
};
