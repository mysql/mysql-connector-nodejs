 ...
 * @property {SocketFactory} socketFactory A factory which can creaes sockt, usually not needed outside tests
 * @property {bool} ssl Enable SSL
 * @property {object} sslOption
 */
