...
/*
ColumnDefinition.prototype.foreignKey = function (table_name) {
    arguments.shift();
    this._foreignKey = { table: table_name, fields: arguments };
    return this;
};
*/
 ...
 * @returns {ColumnDefinition}
 */
ColumnDefinition.prototype.charset = function (charset_name) {
...
/**
 * Set collation
 * @param {String} collation_name
 * @returns {ColumnDefinition}
 */
ColumnDefinition.prototype.collation = function (collation_name) {
    this._collation = collation_name;
    return this;
};
...
ColumnDefinition.prototype.get = function () {
    let definition = Table.escapeIdentifier(this._name) + ' ' + this._type +
        ...
        (this._charset ? " CHARACTER SET " + this._charset + " " : "") + // TODO escape
        (this._collation ? " COLLATE " + this._collation + " " : "") + // TODO escape
