...
/**
 * Add more documents, the document argument, can be a single doc, an array of docs or this can be called with varargs
 * @param document
 * @returns {CollectionAdd}
 */
CollectionAdd.prototype.add = function (document) {
    var documents = (arguments.length === 1 && Array.isArray(document)) ?
        document : Array.prototype.slice.call(arguments);
    documents.forEach(doc => this._document.push(doc));
    return this;
};
