...
var util = require('util'),
    ...
    ForeignKeyDefinition = require('./ForeignKeyDefinition'),
    Table = require('./Table'),
    TableCreater = require('./TableCreater'),
    ColumnDefinition = require('./ColumnDefinition'),
    DatabaseObject = require('./DatabaseObject'),
    ViewCreate = require('./ViewCreate'),
    ViewDrop = require('./ViewDrop');
...
Schema.prototype.createTable = function (name, reuseExisting) {
    return new TableCreater(this, name, reuseExisting);
};
 ...
 *
 * @param {string} name
 * @param {Schema.prototype.Type} type
 * @param {Number=} length
...
Schema.prototype.alterView = function(name) {
    return new ViewCreate(this, name, true);
};
