...
Schema.prototype.getCollections = function () {
    ...
    var self = this;
    var collections = {};
    return this._session._client.sqlStmtExecute("list_objects", args, function (row) {
...
Schema.prototype.dropCollection = function (collection) {
    ...
    return this._session._client.sqlStmtExecute("drop_collection", args, null, null, "xplugin");
};
...
Schema.prototype.getTables = function () {
    ...
    var self = this;
    var tables = {};
    return this._session._client.sqlStmtExecute("SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_CATALOG = ? AND TABLE_SCHEMA = ?", args, function (row) {
...
Schema.prototype.dropTable = function (table) {
    return this._session._client.sqlStmtExecute("DROP TABLE " + Table.escapeIdentifier(this._schema) + '.' + Table.escapeIdentifier(table));
};
