...
function Schema (session, name) {
    ...
    return Object.assign({}, databaseObject(session), {
         ...
         * @returns {Promise.<Array.<Collection>>} A promise that resolves to the array of collection instances.
         */
        getCollections () {
         ...
         * @returns {Promise.<Array.<Table>>} A promise that resolves to the array of table instances.
         */
        getTables () {
            const args = [{ schema: this.getName() }];
            const tables = [];
