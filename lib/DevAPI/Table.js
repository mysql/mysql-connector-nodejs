...
Table.prototype.select = function () {
    ...
    return tableSelect(this._session, this._schema, this._table, fields);
};
...
Table.prototype.insert = function () {
    if (!Array.isArray(arguments[0]) && typeof arguments[0] !== 'string') {
        ...
        return tableInsert(this._session, this._schema, this._table, columns).values(values);
    }

    const columns = parseFlexibleParamList(Array.prototype.slice.call(arguments));

    return tableInsert(this._session, this._schema, this._table, columns);
};
...
Table.prototype.update = function (expr) {
    return tableUpdate(this._session, this._schema, this._table, expr);
};
...
Table.prototype.delete = function (expr) {
    return tableDelete(this._session, this._schema, this._table, expr);
};
