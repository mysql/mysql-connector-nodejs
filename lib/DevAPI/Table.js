...
Table.prototype.existsInDatabase = function () {
    ...
    return this._session._protocol.sqlStmtExecute(query, args, function () { found = true; }).then(function () {
        return found;
    });
};
...
Table.prototype.isView = function () {
    ...
    return this._session._protocol.sqlStmtExecute(query, args, () => { found = true; }).then( () => found );
};
...
Table.prototype.drop = function () {
    ...
    return this._session._protocol.sqlStmtExecute("DROP TABLE " + schema + "." + table).then(function () {
        return true;
    });
};
