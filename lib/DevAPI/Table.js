    ...
    return Object.assign({}, databaseObject(connection), {
        ...
        delete (expr) {
            if (typeof expr !== 'undefined') {
                deprecated(warnings.MESSAGES.WARN_TABLE_DELETE_EXPR_ARGUMENT);
            }
        ...
        insert () {
            if (!Array.isArray(arguments[0]) && typeof arguments[0] !== 'string') {
                deprecated(warnings.MESSAGES.WARN_TABLE_INSERT_OBJECT_ARGUMENT);

                const fields = arguments[0];

                if (typeof fields !== 'object') {
                    throw new Error(errors.MESSAGES.ERR_TABLE_INSERT_FIELDS);
                }
        ...
        update (expr) {
            if (typeof expr !== 'undefined') {
                deprecated(warnings.MESSAGES.WARN_TABLE_UPDATE_EXPR_ARGUMENT);
            }
