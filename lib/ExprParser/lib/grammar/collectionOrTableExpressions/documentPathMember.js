...
const PARSER_OPTIONS = {
    ID: 'documentPathMember',
    NAME: 'DOCUMENT_PATH_MEMBER'
};

/**
 * Sub-parser that matches an atomic member of a document path item in document mode.
 * @private
 ...
 */
const parser = _ => r => {
    return Pa.alt(r.STRING_DQ, r.fieldId);
};
