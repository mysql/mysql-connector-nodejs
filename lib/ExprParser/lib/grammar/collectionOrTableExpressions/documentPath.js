...
const PARSER_NAME = 'DOCUMENT_PATH';

/**
 * Abstract sub-parser that matches the document path of a field identifier in
 * document mode.
 ...
 * @see https://dev.mysql.com/doc/x-devapi-userguide/en/mysql-x-expressions-ebnf-definitions.html#expression-ebnf-documentpath
 * @example
 * .foo.bar
 * .foo[3]
 * .foo.*
