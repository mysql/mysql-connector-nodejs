...
/**
 * Sub-parser that matches a JSON key-value pair.
 ...
 */
const parser = _ => r => Pa
    // The value should be a literal, a json array or json object.
    .seqMap(r.STRING_DQ.skip(Pa.seq(Pa.string(':').trim(Pa.optWhitespace))), r.expr, (key, { value }) => ({
        type: PARSER_OPTIONS.ID, value: { [key]: value }
    }));
