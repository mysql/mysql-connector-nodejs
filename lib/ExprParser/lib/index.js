...
function parser (options) {
    ...
    const parsers = Object.assign({}, keywords(options), booleanExpressions(options), collectionOrTableExpressions(options), {
        ...
        STRING_DQ (r) {
            return Pa
                .seq(
                    Pa.string('"'),
                    Pa.alt(r.SCHAR, Pa.string("'"), r.ESCAPED_DQ).many().tie(),
                    Pa.string('"')
                )
                .tie();
        },
        ...
        ESCAPED_DQ (r) {
            return Pa.alt(Pa.string('\\"'), Pa.string('""'));
        },
        ...
        STRING_SQ (r) {
            return Pa
                .seq(
                    Pa.string("'"),
                    Pa.alt(r.SCHAR, Pa.string('"'), r.ESCAPED_SQ).many().tie(),
                    Pa.string("'")
                )
                .tie();
        },
