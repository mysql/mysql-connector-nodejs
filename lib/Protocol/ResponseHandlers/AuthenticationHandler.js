...
AuthenticationHandler.prototype[Mysqlx.ServerMessages.SESS_AUTHENTICATE_CONTINUE] = function (payload, queueDone) {
...
AuthenticationHandler.prototype[Mysqlx.ServerMessages.SESS_AUTHENTICATE_OK] = function (payload, queueDone) {
    queueDone();
    this._resolve();
};
