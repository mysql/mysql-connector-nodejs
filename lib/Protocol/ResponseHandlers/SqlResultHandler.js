...
SqlResultHandler.prototype[ServerMessages.Type.RESULTSET_COLUMN_META_DATA] = function (payload) {
...
SqlResultHandler.prototype[ServerMessages.Type.RESULTSET_ROW] = function (payload) {
    const row = Resultset.decodeRow(payload, { metadata: this._currentResultsetMetadata });
    ...
    // otherwise, any handler that is provided should be called
    typeof this._metadataHandler === 'function' && this._metadataHandler(this._currentResultsetMetadata);
    typeof this._dataHandler === 'function' && this._dataHandler(row);
};
...
SqlResultHandler.prototype[ServerMessages.Type.SQL_STMT_EXECUTE_OK] = function (_, queueDone) {
