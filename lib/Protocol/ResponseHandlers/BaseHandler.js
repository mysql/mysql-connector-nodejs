...
BaseHandler.prototype.sendMessage = function (queue, stream, buffer) {
    ...
    return new Promise((resolve, reject) => {
        ...
        var entry = function (message, queueDone) {
            if (message.id === Mysqlx.ServerMessages.SERVER_GONE) {
...
BaseHandler.prototype[Mysqlx.ServerMessages.NOTICE] = function (payload) {
 ...
 * @param message
 */
BaseHandler.prototype[Mysqlx.ServerMessages.ERROR] = function (payload, queueDone) {
    queueDone();
