...
Client.prototype.crudFind = function (session, schema, collection, model, projection, criteria, group, having, order, limit, rowcb, metacb, bounds) {
    const data = {
        collection: {
            schema: schema,
            name: collection
...
Client.prototype.crudRemove = function (session, schema, collection, model, criteria, limit, bounds) {
    const data = {
        collection: {
            schema: schema,
            name: collection
