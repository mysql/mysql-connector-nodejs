...
Client.prototype.capabilitiesGet = function () {
    ...
    const protobuf = this.encodePB(messageType, Connection.encodeCapabilitiesGet());
...
Client.prototype.capabilitiesSet = function (properties) {
    ...
    const protobuf = this.encodePB(messageType, Connection.encodeCapabilitiesSet(properties));
...
Client.prototype.authenticate = function (authenticator) {
    ...
    const protobuf = this.encodePB(messageType, Session.encodeAuthenticateStart(authenticator));
...
Client.prototype.crudInsert = function (query) {
    ...
    try {
        protobuf = this.encodePB(ClientMessages.Type.CRUD_INSERT, Crud.encodeInsert(query));
    } catch (err) {
...
Client.prototype.crudFind = function (query, resultSetCursor, metadataCursor) {
    ...
    try {
        protobuf = this.encodePB(ClientMessages.Type.CRUD_FIND, Crud.encodeFind(query));
    } catch (err) {
        return Promise.reject(err);
    }
...
Client.prototype.crudModify = function (query) {
    ...
    try {
        protobuf = this.encodePB(ClientMessages.Type.CRUD_UPDATE, Crud.encodeUpdate(query));
    } catch (err) {
        return Promise.reject(err);
    }
...
Client.prototype.crudRemove = function (query) {
    ...
    try {
        protobuf = this.encodePB(ClientMessages.Type.CRUD_DELETE, Crud.encodeDelete(query));
    } catch (err) {
        return Promise.reject(err);
    }
...
Client.prototype.sqlStmtExecute = function (query, resultSetCursor, metadataCursor) {
    ...
    try {
        protobuf = this.encodePB(ClientMessages.Type.SQL_STMT_EXECUTE, Sql.encodeStmtExecute(query));
    } catch (err) {
        return Promise.reject(err);
    }
...
Client.prototype.close = function () {
    ...
    const protobuf = this.encodePB(messageType, Connection.encodeClose());
