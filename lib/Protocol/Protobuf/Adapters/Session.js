...
exports.decodeAuthenticateContinue = function (data) {
    const proto = AuthenticateContinue.deserializeBinary(tools.createTypedArrayFromBuffer(data));
...
exports.decodeAuthenticateOk = function (data) {
    const proto = AuthenticateOk.deserializeBinary(tools.createTypedArrayFromBuffer(data));
...
exports.decodeAuthenticateStart = function (data) {
    const proto = AuthenticateStart.deserializeBinary(tools.createTypedArrayFromBuffer(data));
...
exports.encodeAuthenticateStart = function (authenticator) {
    ...
    proto.setAuthData(tools.createTypedArrayFromBuffer(authenticator.getInitialAuthData()));

    debug('Mysqlx.Session.AuthenticateStart', JSON.stringify(proto.toObject(), null, 2));

    return tools.createBufferFromTypedArray(proto.serializeBinary());
};
...
exports.encodeAuthenticateContinue = function (data) {
    ...
    proto.setAuthData(tools.createTypedArrayFromBuffer(data));
...
exports.encodeClose = function () {
    ...
    return tools.createBufferFromTypedArray(message.serializeBinary());
};
