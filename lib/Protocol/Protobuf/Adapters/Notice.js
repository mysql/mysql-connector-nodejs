...
exports.decodeFrame = function (data) {
    const proto = Frame.deserializeBinary(tools.createTypedArrayFromBuffer(data));
...
exports.decodeSessionStateChanged = function (data) {
    return decodeSessionStateChanged_(tools.createTypedArrayFromBuffer(data));
};
...
exports.decodeSessionVariableChanged = function (data) {
    return decodeSessionVariableChanged_(tools.createTypedArrayFromBuffer(data));
};
...
exports.decodeWarning = function (data) {
    return decodeWarning_(tools.createTypedArrayFromBuffer(data));
};
