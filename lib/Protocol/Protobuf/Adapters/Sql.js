...
exports.createStmtExecute = function (query, options) {
    ...
    proto.setStmt(tools.createTypedArrayFromBuffer(new Buffer(query.getSQL())));
...
exports.decodeStmtExecuteOk = function (data) {
    const proto = StmtExecuteOk.deserializeBinary(tools.createTypedArrayFromBuffer(data));
