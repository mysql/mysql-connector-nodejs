...
/**
 * Creates a wrapper of a generic Mysqlx.Crud.Update instance for a given statement.
 * @param {module:CollectionModify|module:TableUpdate} statement
 * @param {Object} [options] - extended options
 * @returns {module:adapters.Mysqlx.Crud.Update}
 */
Update.create = function (statement, options) {
    ...
    proto.setOperationList(statement.getOperations().map(operation => updateOperation.create(operation, options).valueOf()));
