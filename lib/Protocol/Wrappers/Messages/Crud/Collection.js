...
/**
 * Creates a wrapper for a Mysqlx.Crud.Collection protobuf messasge
 * with a given name and schema name.
 * @private
 * @param {string} name
 * @param {string} schemaName
 * @returns {module:adapters.Mysqlx.Crud.Collection}
 */
Collection.create = function ({ name, schemaName }) {
    const proto = new CollectionStub();
    proto.setName(name);
    proto.setSchema(schemaName);
