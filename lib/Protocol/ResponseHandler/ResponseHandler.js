...
const Mysqlx = require('../Protobuf/Mysqlx');
...
ResponseHandler.prototype[ServerMessages.Type.NOTICE] = function (payload) {
 ...
 * @param message
 */
ResponseHandler.prototype[ServerMessages.Type.ERROR] = function (payload, queueDone) {
    queueDone();
