...
SqlResultHandler.prototype[Messages.ServerMessages.SQL_COLUMN_META_DATA] = function (message, queueDone) {
...
SqlResultHandler.prototype[Messages.ServerMessages.SQL_ROW] = function (message, queueDone) {
    var row = [];
    var self = this;
...
SqlResultHandler.prototype[Messages.ServerMessages.SQL_RESULT_FETCH_DONE] = function (message, queueDone) {
};
