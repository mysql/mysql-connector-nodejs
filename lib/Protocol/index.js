...
function Protocol(stream) {
    ...
    this.serverMessages[Messages.ServerMessages.NOTICE] = "Mysqlx.Notice.Warning";
    this.serverMessages[Messages.ServerMessages.RESULTSET_COLUMN_META_DATA] = "Mysqlx.Resultset.ColumnMetaData";
    this.serverMessages[Messages.ServerMessages.RESULTSET_ROW] = "Mysqlx.Resultset.Row";
    this.serverMessages[Messages.ServerMessages.RESULTSET_FETCH_DONE] = "Mysqlx.Resultset.FetchDone";
    this.serverMessages[Messages.ServerMessages.RESULTSET_FETCH_SUSPENDED] = "XXMysqlx.Resultset.FetchSuspended";
    this.serverMessages[Messages.ServerMessages.RESULTSET_FETCH_DONE_MORE_RESULTSETS] = "Mysqlx.Resultset.FetchDoneMoreResultsets";
    this.serverMessages[Messages.ServerMessages.SQL_STMT_EXECUTE_OK] = "Mysqlx.Sql.StmtExecuteOk";
    this.serverMessages[Messages.ServerMessages.RESULTSET_FETCH_DONE_MORE_OUT_PARAMS] = "Mysqlx.ResultsetFetchDoneMoreOutPArams";
    ...
    this.clientMessages[Messages.ClientMessages.EXPECT_OPEN] = "XXMysqlx.Expect.Open";
    this.clientMessages[Messages.ClientMessages.EXPECT_CLOSE] = "XXMysqlx.Expect.Close";
    ...
    documents.forEach(function (doc) {
        data.row.push({
            field: [{
                ...
                constant: dt.encode(JSON.stringify(doc))
            }]
        });
    });
