...
proto.Mysqlx.Expect.Open.Condition.toObject = function(includeInstance, msg) {
  var f, obj = {
    conditionKey: (f = jspb.Message.getField(msg, 1)) == null ? undefined : f,
...
/**
 * @param {number} value
 * @return {!proto.Mysqlx.Expect.Open.Condition} returns this
 */
 ...
 * @return {!proto.Mysqlx.Expect.Open} returns this
 */
