...
var iauthenticator = require('./IAuthenticator');
...
PlainAuth.prototype.getInitialAuthData = function () {
    var data = new Buffer(this._user.length + 3);
    data[0] = 0x00;
    data.write(this._user, 1);
    data[this._user.length + 1] = 0x00;
    data[this._user.length + 2] = 0x00;
    return data;
};

PlainAuth.prototype.getNextAuthData = function (serverData) {
    throw new Error("Unexpeced data: " + serverData);
};
